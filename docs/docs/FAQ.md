...
??? question "What are the best models for Autocode?"
For the best experience with Autocode, we recommend using the following models from our 19 supported providers:
...
Autocode uses a modular provider architecture. To add a new provider:
...
Autocode provides multiple ways to access help and documentation:
...
??? question "How do I get the best results with Autocode?"
...
MCP extends Autocode's AI capabilities with external tools:
...
??? question "How do I deploy my Autocode projects?"
Autocode supports one-click deployment to multiple platforms:
...
Autocode provides comprehensive Git and GitHub integration:
...
??? question "How do I contribute to Autocode?"
Check out our [Contribution Guide](CONTRIBUTING.md) for more details on how to get involved!

??? question "What are the future plans for Autocode?"
Visit our [Roadmap](https://roadmap.sh/r/ottodev-roadmap-2ovzo) for the latest updates.  
 New features and improvements are on the way!

??? question "Why are there so many open issues/pull requests?"
Autocode began as a small showcase project on @ColeMedin's YouTube channel to explore editing open-source projects with local LLMs. However, it quickly grew into a massive community effort!

    We're forming a team of maintainers to manage demand and streamline issue resolution. The maintainers are rockstars, and we're also exploring partnerships to help the project thrive.

## New Features & Technologies

??? question "What's new in Autocode?"
Recent major additions to Autocode include:
...
Autocode offers templates for popular frameworks and technologies:
...
??? question "How do local LLMs compare to larger models like Claude 3.5 Sonnet for Autocode?"
...
If you're having trouble with MCP integrations:
    ...
    - **Test server connectivity** outside of Autocode
...
[Join the Autocode Community](https://thinktank.ottomator.ai/c/bolt-diy/17){target=\_blank} for discussions and help
